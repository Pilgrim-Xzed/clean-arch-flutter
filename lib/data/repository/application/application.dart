...
import 'package:diotest/domain/repository/application/application.dart';
...
class KApplicationRepository implements ApplicationRepository {
  ...
  KApplicationRepository(this._dio, this._errorInterceptor,
      this._requestInterceptor, this._responseInterceptor);
  @override
